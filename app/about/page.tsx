          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              },
              {
                ...
                exp: '8+ years in education programs',
                focus: 'GyanDaan & Skill Development',
              },
              {
                role: 'Health & Hygiene Lead',
                exp: '7+ years in public health',
                focus: 'Health Awareness & Campaigns',
              },
              {
                role: 'Volunteer Manager',
                exp: '5+ years managing community volunteers',
                focus: 'Volunteer Engagement & Development',
              },
            ].map((member, idx) => (
