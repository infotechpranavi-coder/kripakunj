...
export function Footer() {
  return (
    <footer className="bg-linear-to-br from-primary to-primary/90 text-primary-foreground">
            ...
            <div className="mb-6 sm:mb-8">
              ...
              <div className="flex flex-wrap gap-3 sm:gap-4">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-10 h-10 bg-linear-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 rounded-full flex items-center justify-center transition-all duration-300 transform hover:scale-110 hover:rotate-3"
