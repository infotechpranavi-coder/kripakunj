...
export function SocialMediaFloatingIcons({ onVolunteerClick }: SocialMediaFloatingIconsProps) {
  return (
    <div className="fixed right-6 bottom-24 z-50 flex flex-col items-center space-y-4">
      ...
      <Link
        href="https://wa.me/message/4PWWPPLUE6ZWE1"
        target="_blank"
        rel="noopener noreferrer"
        className="bg-[#25D366] text-white w-14 h-14 rounded-full flex items-center justify-center shadow-2xl hover:shadow-[#25D366]/50 transition-all duration-300 transform hover:scale-110 group relative"
